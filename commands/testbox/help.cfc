component excludeFromHelp=true extends="testboxCLI.models.BaseCommand" {
	...
	function run(){
		...
		variables.print
			...
			.boldCyanLine( "  ─────────────────────────────────────────────────────" )
			.line()
			.boldWhite( "  testbox run" )
			.line( "              Run your test suites via HTTP" )
			.boldWhite( "  testbox watch" )
			.line( "            Watch files and auto-run tests on change" )
			.boldWhite( "  testbox info" )
			.line( "             Show the active TestBox version and path" )
			.boldWhite( "  testbox reinstall" )
			.line( "        Wipe and reinstall the CLI-bundled TestBox" )
			.boldWhite( "  testbox create" )
			.line( "           Create BDD specs or xUnit test bundles" )
			.boldWhite( "  testbox generate" )
			.line( "         Generate harnesses, browsers, and more" )
			.boldWhite( "  testbox docs" )
			.line( "             Open the TestBox documentation in a browser" )
			.boldWhite( "  testbox apidocs" )
			.line( "          Open the TestBox API docs in a browser" )
			.line()
			.boldCyanLine( "  ─────────────────────────────────────────────────────" )
