component excludeFromHelp=true extends="testboxCLI.models.BaseCommand" {
	...
	function run(){
		...
		variables.print
			...
			.boldCyanLine( "  ─────────────────────────────────────────────────────" )
			.line()
			.boldWhite( "  testbox create bdd" )
			.line( "     <name>   Create a new BDD spec" )
			.boldWhite( "  testbox create unit" )
			.line( "    <name>   Create a new xUnit test bundle" )
			.boldWhite( "  testbox generate module" )
			.line( " <name>   Create a TestBox module skeleton" )
			.line()
			.boldCyanLine( "  ─────────────────────────────────────────────────────" )
